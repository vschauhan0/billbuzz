  ...
  return (
    <>
      ...
      <div className="">
        <nav>
          <div
            className={`fixed top-0 left-0 z-50 h-full w-64 bg-white dark:bg-gray-800 shadow-lg transform transition-transform duration-300 ${
              isSidebarOpen ? "translate-x-0" : "-translate-x-full"
            }`}
          >
            <span className=" text-xl font-bold">
              <Link to="/" onClick={closeSidebar}>
                <span className="text-red-600 text-2xl">B</span>ill
                <span className="text-red-600 text-2xl">B</span>uzz
              </Link>
            </span>
            <button
              type="button"
                  ...
                  <>
                    <li>
                      ...
                      >
                        ...
                        <span className="ms-3">Company Details</span>
                      </Link>
                    </li>
                  </>
                ) : (
          ...
          <ul className="flex justify-between p-2 ">
            ...
            {userEmail ? (
              <>
                <h1 className="text-xl items-center justify-center"> Welcome, {userEmail} </h1>
